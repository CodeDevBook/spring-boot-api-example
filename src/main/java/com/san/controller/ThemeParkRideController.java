...
import com.san.entity.ThemeParkRide;
import com.san.repository.ThemeParkRideRepository;
...
public class ThemeParkRideController {
    ...
    @PutMapping(value = "/ride/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
